...
sNext:"Tiếp",sPrevious:"Trước"},sEmptyTable:"No data available in table",sInfo:"Trình bày _START_ đến _END_ trên _TOTAL_ người dùng",sInfoEmpty:"Trình bày 0 đến 0  người dùng",sInfoFiltered:"(Lọc từ _MAX_  người dùng)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Trình bày _MENU_ người dùng",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
